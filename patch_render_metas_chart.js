...
// Ensure we don't have multiple insertions
const insertionPoint2 = `    function renderCategoryRadarChart(data) {`;
...
const newFunction = `    function renderMetasRadarChart(data) {
        ...
        xRenderer.labels.template.setAll({
            ...
            centerY: am5.p50,
            fontSize: 12,
            fill: am5.color(0x94a3b8) // Tailwind slate-400
        });
        ...
        yRenderer.labels.template.setAll({
            ...
            fontWeight: "500",
            fontSize: 12,
            fill: am5.color(0xf8fafc) // Tailwind slate-50
        });
...
if (code.includes('function renderCategoryRadarChart(data) {') && !code.includes('function renderMetasRadarChart(data) {')) {
    code = code.replace(insertionPoint2, newFunction);
    fs.writeFileSync('/app/js/app/app.js', code, 'utf8');
    console.log("renderMetasRadarChart function added.");
} else {
    console.log("Already added or insertion point not found.");
}
